...
def exitSequence():
    print()
    print('Name Snake Animation, by Jeremy Beard ' + chr(9787))
    sys.exit()
...
SNAKE_STR = 'snake_str'
snakes = []
initSnakePosition = int(WIDTH/2)-int(NUM_SNAKES/2)
for i in range(NUM_SNAKES):
    snakes.append({POSITION: initSnakePosition,
                   DIR: random.choice(DIRECTIONS),
                   FINAL_POS: 0,
                   SNAKE_STR: userName[i]})
