#! /usr/bin/python3
# 20210901 DVD Logo moving animation
# Author: Jeremy Beard
...
NUMBER_OF_LOGOS = 1 # (!) Trying changing this to 1 or 100.
...
def main():
    ...
    while True: #main program loop
        for logo in logos: # Handle each logo in the logos list.
            ...
            # characters are twice as fall as they are wide.)
...
if __name__ == '__main__':
    try:
        ...
        print()
        print('Bouncing DVD Logo, by Al Swigart')
